...
struct ContactDetails: View {
    ...
    var body: some View {
        VStack{
            ...
            TextFieldWithHeading(label: "Phone Number", textFieldValue: $selectedContactItem.phoneNo, placeholder: "Enter phone number", isLockButtonEnabled: true, isPasswordField: false,isEnabled: false)
                .padding(.top,10)
